...
import { IAuthDocument } from '@hansin91/jobber-shared';
import { compare, hash } from 'bcryptjs';
import { DataTypes, Model, ModelDefined, Optional } from 'sequelize';

const SALT_ROUND = 10;

type AuthUserCreationAttributes = Optional<IAuthDocument, 'uuid' | 'createdAt' | 'passwordResetToken'| 'passwordResetExpires'>;
